...
const actions = {
  UPDATE_NUMBER_OF_PEOPLE: 'UPDATE_NUMBER_OF_PEOPLE',
  UPDATE_SLICES_PER_PERSON: 'UPDATE_SLICES_PER_PERSON',
  UPDATE_SLICES_PER_PIE: 'UPDATE_SLICES_PER_PIE'
};
...
const Calculator = ({ dispatch, state }: CalculatorProps) => {
  return (
    <form onSubmit={() => {}}>
